...
const CategoryBanner = ({ category }: { category: ICategory }) => {
  return (
    <Card fullWidth className="h-[500px]">
      <div
        className="group relative flex flex-col items-center justify-center p-4 bg-cover bg-center transition-transform duration-300 hover:scale-105 h-full"
